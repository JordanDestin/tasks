    ...
    <header class="flex flex-shrink-0">
        ...
        <div class="flex-1 flex bg-gray-700 px-6 items-center justify-between">
            <nav>
                ...
                <a href="{{ route('team.task.create',$teamId) }}" class="ml-2 hover:bg-gray-600 rounded-lg inline-block text-sm font-medium text-white px-3 py-2 leading-none">@lang("Create a task")</a>
                <a href="#" class="hover:bg-gray-600 rounded-lg inline-block text-sm font-medium text-white px-3 py-2 leading-none">Reporting</a>
                <a href="#" class="hover:bg-gray-600 rounded-lg inline-block text-sm font-medium text-white px-3 py-2 leading-none">Manage</a>
            </nav>
            <div class="flex items-center">
                <span class="relative">
                    ...
                    <input class="focus:bg-white focus:text-gray-900 focus:placeholder-gray-700 pl-10 pr-4 py-2 leading-none block w-full bg-gray-900 rounded-lg text-sm placeholder-gray-400 text-white" placeholder="Search" />
                </span>
                ...
                <button class="ml-6 text-gray-400 hover:text-gray-200">
                    <i class="fa fa-question-circle-o h-5 w-5 fill-current" aria-hidden="true" style="color: #fff;"></i>
                </button>
            </div>
        </div>
    </header>
